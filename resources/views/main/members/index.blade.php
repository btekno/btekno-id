@extends('layouts.app')
@section('title', me()->username . ' ('.me()->name.') ·')

@section('content')
    <div class="overflow-auto" style="margin-top: 65px;height: calc(100vh - 65px);">
                ...
                <div class="profiles_content">
                    ...
                    <div class="profile_avatar">
                        <div class="profile_avatar_holder"> 
                            <img src="assets/images/avatars/avatar-8.jpg.png" alt="">
                        </div>
            ...
            <div class="uk-switcher lg:mt-8 mt-4" id="timeline-tab">
                       ...
                       <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                           ...
                           <div uk-lightbox>
                               <div class="grid grid-cols-2 gap-2 p-2">
                                   ...
                                   <a href="assets/images/post/img-4.jpg.png" class="col-span-2">  
                                       <img src="assets/images/post/img-4.jpg.png" alt="" class="rounded-md w-full lg:h-76 object-cover">
                                   </a>
                                   <a href="assets/images/post/img-4.jpg.png">  
                                       <img src="assets/images/post/img-2.jpg" alt="" class="rounded-md w-full h-full">
                                   </a>
                                   <a href="assets/images/post/img-4.jpg.png" class="relative">  
                    ...
                    <div class="w-full space-y-6">
                        ...
                        <div class="widget card p-5 border-t">
                            ...
                            <div>
                              ...
                              <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-gray-50">
                                  <a href="timeline-group.html" class="w-12 h-12 flex-shrink-0 overflow-hidden rounded-full relative">
                                      <img src="assets/images/group/group-2.jpg.png" class="absolute w-full h-full inset-0" alt="">
                                  </a>
                                  <div class="flex-1">
                ...
                <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-3 mt-5">
                        ...
                        <div>
                            <div class="bg-gray-200 max-w-full lg:h-44 h-36 rounded-lg relative overflow-hidden shadow uk-transition-toggle">
                                <img src="assets/images/post/img-4.jpg.png" class="w-full h-full absolute object-cover inset-0">
                                <!-- overly-->
                                <div class="-bottom-12 absolute bg-gradient-to-b from-transparent h-1/2 to-gray-800 uk-transition-slide-bottom-small w-full"></div>
                                <div class="absolute bottom-0 w-full p-3 text-white uk-transition-slide-bottom-small">
                                    <div class="text-base"> Image description  </div>
